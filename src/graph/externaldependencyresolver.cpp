...
bool ExternalDependencyResolver::is_resolved() const {
	return unresolved_dependencies.begin() == unresolved_dependencies.end();
}

void ExternalDependencyResolver::add_unresolved_dependency(
	const std::shared_ptr< ExternalDependency >& dependency) {
